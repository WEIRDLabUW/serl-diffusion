...
def create_sample_indices(
        ...
        pad_before: int = 0, pad_after: int = 0, labels: Union[str, None] = None):
    ...
    for i in range(len(episode_ends)):
        ...
        for idx in range(min_start, max_start + 1):
            ...
            if labels is not None and  buffer_start_idx not in labels:
                continue
    ...
    def __init__(self,
        ...
        for i in range(len(data)):
            ...
            if data[i]['dones']:
                ...
                # Temp solution
                if num_trajectories != -1 and len(episode_ends) >= num_trajectories:
                    break
